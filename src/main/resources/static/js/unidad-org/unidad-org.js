$(document).ready(function(){
    ...
    $("#btn_registrar").on("click", function () {
        ...
        $.ajax({
            type: "POST",
            url: "/unidades-organizacionales/store",
    ...
    $("#example1").on("click",".edit-unidad", function () {
        ...
        $.get('/unidades-organizacionales/edit/' + idUnidad, function (data) {
            ...
            $.get('/api/empleados-unidad/' + idUnidad, function (data_emp) {
                var options = "";
    ...
    $("#btn_actualizar").on("click", function () {
        ...
        $.ajax({
            type: "POST",
            url: "/unidades-organizacionales/update",
    ...
    $("#example1").on("click", ".delete_btn",function () {
        ...
        $("#delete").on("click", function () {
            $.ajax({
                type: "POST",
                url: "/unidades-organizacionales/delete",
