...
public interface TipoMovimientoService {
	...
	public abstract List<TipoMovimiento> getByEsDescuentoAndEsPatronalAndEsFijoAndHabilitado(boolean esDescuento, boolean esPatronal, boolean esFijo, boolean tipoMovimientoHabilitado);
}
